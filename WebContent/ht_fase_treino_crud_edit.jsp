     ...
     <body> 
        ...
        <main class="container">
            ...
            <form action="fase-treino" method="post">
            	...
            	<input type="hidden" value="${rqIdFaseTreino.idFaseTreino}" name="id_fase_treino">
                <div class="row">
                    <div class="col-7 container d-flex justify-content-center">
                        <h4>Edição da Fase de Treino</h4>  
                    </div>
                ...
                <div class="form-group">
                        ...
                        <input type="text" name="descr_tp_treino" id="id_descr_tp_treino" class="form-control"
               	 		value="${rqIdFaseTreino.dsTipoTreino}">	
               	</div>
                <div class="form-group">
                        ...
                        <input type="text" name="descr_objetivo" id="id_descr_objetivo" class="form-control"
               	 		value="${rqIdFaseTreino.dsObjetivoTreino}">	
               	</div>
   				...
   				<div class="form-group">
					...
					<select name="modalidade" id="id-modalidade" class="form-control">
						...
						<c:forEach items="${rqModalidades}" var="c">
							<c:if test="${c.codigoModalidade == rqIdFaseTreino.modalidade.codigoModalidade}">
               	...
               	<a href="fase-treino?acao=listar" class="btn btn-danger btn-sm">Cancelar</a>
            	<br>
            </form>
        </main>
