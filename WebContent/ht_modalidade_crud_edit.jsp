     ...
     <body> 
        ...
        <main class="container-fluid">
            ...
            <form action="modalidade" method="post">
            	...
            	<input type="hidden" value="${modalidade.codigoModalidade}" name="cd_modalidade">
                <div class="row">
                    <div class="col-7 container d-flex justify-content-center">
                        <h4>Edição de Modalidades</h4>  
                    </div>
                ...
                <div class="form-group">
                   <label for="id_ds_modalidade">Descrição da Modalidade : </label>
                   <input type="text" name="ds_modalidade" id="id_ds_modalidade" class="form-control"
                   value="${modalidade.descricaoModalidade}">
               	</div>
               	<input type="submit" value="Salvar" class="btn btn-success active btn-sm">
               	<a href="modalidade?acao=listar" class="btn btn-danger btn-sm">Cancelar</a>
            </form>
        </main>
