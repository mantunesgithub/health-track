            ...
            <form action="personal" method="post">
                ...
                <div class="row">
                    <div class="col-7 container d-flex justify-content-center">
                        <h4>Inclusão de Personal Trainer</h4>   
                    </div>
                ...
                <div class="form-group">
                   <label for="id_cpf_personal">CPF</label>
                   <input type="number" name="cpf_personal" id="id_cpf_personal" class="form-control">
               	</div>
                <div class="form-group">
                ...
                <div class="form-group">
                   <label for="id_ddd_personal">(DDD)</label>
