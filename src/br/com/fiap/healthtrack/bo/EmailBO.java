...
public class EmailBO {
	...
	public void enviarEmail(String destinatario, String assunto, String mensagem) throws EmailException{
		final String username = "mantunes001@gmail.com";
		final String password = "gmaima16";
		...
		try {
			...
			throw new EmailException("Erro ao enviar o e-mail - desbloquear Avast e no Google  ");
		}
	}
}